$("body").hide().fadeIn(1e3),$(".textArea").hide().slideDown(1e3);const storyText=document.querySelector(".textArea > p"),userInput=document.querySelector(".controls > input"),enterBtn=document.querySelector(".controls > button");var farukiRelationship="good",gameStates=[{scene:0,text:"Do you want to start your journey? 'Yes' to get started.",options:[{value:"yes",nextScene:1},]},{scene:1,text:"The snowball effect dictates that anything so little can emerge into pure catastrophe...",options:[{value:"",nextScene:2},]},{scene:2,text:`On <u>April 19th, 2023</u>, beloved cat, Dallas, disappeared spontaneuously from the Faruki mansion.
               ...
               *Mr. Faruki leads you to the master bedroom*`,options:[{value:"",nextScene:15}]},{scene:15,text:`The room looks spotless, you see no clear evidence of criminal activity.
               <br>
               Where do you want to check first? 'Carpet', 'Bed', 'Window'`,options:[{value:"carpet",nextScene:17},{value:"bed",nextScene:18},{value:"window",nextScene:19}]},{scene:16,text:"Where do you want to check next? 'Carpet', 'Bed', 'Window'",options:[{value:"carpet",nextScene:17},{value:"bed",nextScene:18},{value:"window",nextScene:19}]},{scene:17,text:`*You look carefully at the carpet and notice that certain spots seem slightly darker
               than others. You look closer and notice that those spots are damp.*`,options:[{value:"",nextScene:20}]},{scene:18,text:`*You look at the bed to search for evidence*
               <br>
               ...
               <span class='side-char'>Mr.Faruki</span> N-no, it's normally always closed..`,options:[{value:"",nextScene:20}]},{scene:20,text:`*Mr.Faruki notices you looking around and immediately interrupts*
               <br>
